  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default:
          'size-full pt-4 pb-72 text-base sm:px-[max(64px,calc(50%-350px))]',
        demo: 'size-full  pt-4 pb-72 text-base sm:px-[max(64px,calc(50%-350px))]',
        fullWidth: 'size-full  pt-4 pb-72 text-base sm:px-24',
        none: '',
